...
c1 <- owidG %>% filter(date2 >=as.Date("2020-02-26") & date2<=as.Date("2020-06-24")) %>% ggplot(aes(x=date2,y=new_cases)) + geom_bar(stat="identity",width=0.8,position=position_dodge()) + theme_minimal() + ylab("New cases per day") + xlab("Date")  + scale_x_date(date_breaks=("1 month"),date_labels="%d %b %y") #+ geom_vline(xintercept=as.Date("2020-06-24"),color="red")

c2 <- owidG %>% filter(date2 >=as.Date("2020-02-26") & date2<=as.Date("2020-06-24")) %>% ggplot(aes(x=date2,y=total_cases)) + geom_line() + theme_minimal() + ylab("Cumulative cases") + xlab("Date")  + scale_x_date(date_breaks=("1 month"),date_labels="%d %b %y") 

c3 <- owidG %>% filter(date2 >=as.Date("2020-02-26") & date2<=as.Date("2020-06-24")) %>% ggplot(aes(x=date2,y=total_cases_per_million)) + geom_line() + theme_minimal() + ylab("Cumulative cases per million") + xlab("Date")  + scale_x_date(date_breaks=("1 month"),date_labels="%d %b %y") 

d1 <- owidG %>% filter(date2 >=as.Date("2020-02-26") & date2<=as.Date("2020-06-24")) %>% ggplot(aes(x=date2,y=total_deaths)) + geom_line() + theme_minimal() + ylab("Cumulative deaths") + xlab("Date")  + scale_x_date(date_breaks=("1 month"),date_labels="%d %b %y") 
