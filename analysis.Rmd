...
CS %>% ggplot(aes(x=AgeGroup.X,y=AgeGroup.Y,fill=n)) + xlab("Age group of confirmed case") + ylab("Age group of contact")  + theme_minimal() + geom_tile() + ggtitle("Number of contacts by age group")
CS %>% ggplot(aes(x=AgeGroup.X,y=AgeGroup.Y,fill=p)) + xlab("Age group of confirmed case") + ylab("Age group of contact")  + theme_minimal() + geom_tile() + ggtitle("Proportion of contacts leading to transmission")
